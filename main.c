	...
	void menuExecute(int matrix[maxSize][maxSize], int choice){
		...
		switch(choice){
			...
			case 5:
				...
				showMatrix(matrix, "A matriz: ");
				gotoxy(3, 10 + rows*2);
				if(result)printf("É quadrado mágico");
			...
			case 6:
				...
				showMatrix(matrix, "A matriz: ");
				gotoxy(3, 10 + rows*2);
				if(result)printf("É quadrado latino");
				else printf("Não é quadrado latino");
				gotoxy(3, 11 + rows*2);
				textcolor(4);
				printf("Pressione qualquer tecla para continuar");
				textcolor(0);
			...
			case 7:
				...
				showMatrix(matrix, "A matriz: ");
				gotoxy(3, 10 + rows*2);
				if(result)printf("É matriz de permutação");
				else printf("Não é matriz de permutação");
				gotoxy(3, 11 + rows*2);
				textcolor(4);
				printf("Pressione qualquer tecla para continuar");
				textcolor(0);
